...
var (
	ErrorMessageLengthOutOfBounds              = errors.New("message DLC must be a number from 1 to 64")
	ErrorSignalStartBitOutOfBounds             = errors.New("signal start bit must be a number from 0 to 63")
	ErrorSignalLengthOutOfBounds               = errors.New("signal DLC must be a number from 1 to 64")
	...
	ErrorSignalFigures                         = errors.New("sum of integer and decimal figures must be equal to signal length")
